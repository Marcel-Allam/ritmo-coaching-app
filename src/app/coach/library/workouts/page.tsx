    ...
    <div className="space-y-8 p-6 md:p-8">
      ...
      <Card className="border-2 border-gray-200 bg-gray-50">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_0.35fr] lg:items-center">
          <div>
            <h2 className="text-2xl font-black uppercase text-[#000000]">Workout library manager</h2>
            <p className="mt-2 text-sm text-gray-700">
              This page is the dedicated management surface for reusable workout templates. The current Library tab remains the preview/browse view; editing controls will live here.
            </p>
          </div>
